declare function Liquid(options: Liquid.Options): Liquid.LiquidEngine;

declare namespace Liquid {
  export class LiquidEngine {
    init(tag, filter, options): LiquidEngine
    respectCache(key, getter): Promise<any>
    evalValue: typeof Liquid.evalValue
