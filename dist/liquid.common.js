...
function anySeries(iterable, iteratee) {
    ...
    iterable.forEach(function (item, idx) {
        ret = ret.catch(function () { return iteratee(item, idx, iterable); });
    });
    return ret;
}
/*
...
var fs = {
    stat: promisify(fs$1.stat),
    readFile: promisify(fs$1.readFile)
};
function resolve(filepath, root, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, anySeries(paths, function (path) { return __awaiter(_this, void 0, void 0, function () {
                    var e_1;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.liquid.getTemplate(filepath, scope.opts.root)];
                    case 6:
                        templates = _a.sent();
                        scope.push(hash);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.liquid.getTemplate(layout, scope.opts.root)];
                    case 2:
                        templates = _a.sent();
                        scope.push(hash);
                        scope.blockMode = BlockMode$1.OUTPUT;
...
var tags = {
    assign: assign$1, 'for': For, capture: capture, 'case': Case, comment: comment, include: include, section: section, decrement: decrement, increment: increment, cycle: cycle, 'if': If, layout: layout, block: block, raw: raw, tablerow: tablerow, unless: unless, 'break': Break, 'continue': Continue
};
...
var filters = assign({}, html, str, math, url, date, obj, array);
